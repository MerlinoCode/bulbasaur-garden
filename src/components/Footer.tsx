export default function Footer() {
  return (
    <footer className="py-2 mt-4 text-center text-white bg-zinc-900 border-t border-zinc-800">
      <div className="max-w-6xl mx-auto px-6">
        ...
        <p className="text-xs text-zinc-500 mt-1">
          ...
          <a 
            href="https://portfolio-merlinocode.vercel.app" 
            target="_blank" 
            rel="noopener noreferrer"
            className="text-zinc-400 hover:text-white transition-colors"
          >
            Jonathan Leonel Merlino
          </a>
        </p>
        <div className="flex justify-center gap-6 mt-4">
            ...
            <a href="https://discord.com" target="_blank" rel="noopener noreferrer" className="text-zinc-500 hover:text-white transition-colors">
